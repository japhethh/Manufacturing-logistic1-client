...
const Dashboard = () => {
  ...
  const youtubelink = [
    ...
    {
      link: "https://www.youtube.com/embed/PLLRRXURicM?si=HsicIe0WvVDu4qnh",
      category: "lofi",
    },
  ];
  return (
      ...
      <div className="flex">
        <div className="flex-col w-full container-md mx-auto p-4 ">
          <div className="flex flex-col gap-4">
            ...
            {/* Funny Category */}
            <div>
              <h2 className="font-semibold text-xl">Funny</h2>
              <div className="flex flex-wrap gap-2">
                {youtubelink
            ...
            {/* Facebook Category */}
            <div>
              <h2 className="font-semibold text-xl">Facebook Videos</h2>
              <div className="flex flex-wrap gap-2">
                {youtubelink
            ...
            {/* Lofi Category */}
            <div>
              <h2 className="font-semibold text-xl">Lofi</h2>
              <div className="flex flex-wrap gap-2">
                {youtubelink
