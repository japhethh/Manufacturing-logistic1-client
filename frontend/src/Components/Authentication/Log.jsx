        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-6">
            ...
            <input
              type="text"
              id="userName"
              className="shadow-sm rounded-md w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500"
          ...
          <div className="mb-6">
            ...
            <a href="#" className="text-xs text-gray-600 hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
              Forgot Password?
            </a>
          </div>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              <input
                type="checkbox"
                id="remember"
                className="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500 focus:outline-none"
                defaultChecked
              />
