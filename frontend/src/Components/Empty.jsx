...
const Empty = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-50 shadow-lg rounded-lg">
      <h2 className="text-3xl font-semibold text-gray-800 mb-4">No Data Available Pa Dito Pre HAHAHA</h2>
      ...
      <div className="overflow-x-auto mb-4 w-full">
        <table
          ...
          className="display cell-border stripe hover w-full text-sm text-gray-700"
        >
          ...
          <tbody>
            ...
            <tr>
              <td colSpan="5" className="text-center text-gray-500">No products available</td>
            </tr>
          </tbody>
        </table>
      </div>
