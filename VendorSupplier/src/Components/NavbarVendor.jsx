    ...
    <div className="navbar sticky top-0 z-50 bg-white px-5 shadow-md">
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="navbar-end gap-4 flex">
          {/* Search Button */}
          <button className="text-black size-8 p-2 hidden md:block lg:block" aria-label="Search">
          ...
          <div className="dropdown dropdown-end items-center hidden md:block lg:block">
            <img src={joji} tabIndex={0} role="button" alt="User Profile" className="rounded-full size-8" />
            <ul tabIndex={0} className="menu dropdown-content text-black rounded-box z-[1] mt-4 w-52 p-2 shadow">
